...
from messente_api.models.rcs_card_orientation import RcsCardOrientation
from messente_api.models.rcs_image_alignment import RcsImageAlignment
from typing import Optional, Set
from typing_extensions import Self

class RcsStandaloneCard(BaseModel):
    """
    RCS standalone card object.
    """ # noqa: E501
    card_orientation: RcsCardOrientation
    thumbnail_image_alignment: RcsImageAlignment
    card_content: RcsCardContent
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["card_orientation", "thumbnail_image_alignment", "card_content"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.card_content:
            _dict['card_content'] = self.card_content.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "card_orientation": obj.get("card_orientation"),
            "thumbnail_image_alignment": obj.get("thumbnail_image_alignment"),
            "card_content": RcsCardContent.from_dict(obj["card_content"]) if obj.get("card_content") is not None else None
        })

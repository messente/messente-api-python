...
class ViberTemplate(BaseModel):
    """
    Viber template object.
    """ # noqa: E501
    id: StrictStr = Field(description="Template ID.")
    lang: StrictStr = Field(description="Template language code.")
    params: Optional[Dict[str, StrictStr]] = Field(default=None, description="Optional template parameters as key-value string pairs.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "lang", "params"]

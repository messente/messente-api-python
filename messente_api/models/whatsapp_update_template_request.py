...
class WhatsappUpdateTemplateRequest(BaseModel):
    """
    Request to create a WhatsApp template
    """ # noqa: E501
    category: Optional[WhatsappTemplateCategory] = None
    components: Optional[List[WhatsappTemplateComponent]] = Field(default=None, description="List of template components")

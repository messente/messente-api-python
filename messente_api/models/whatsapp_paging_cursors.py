...
class WhatsappPagingCursors(BaseModel):
    """
    WhatsApp paging cursors object.
    """ # noqa: E501
    before: Optional[StrictStr] = Field(default=None, description="The template before the first template in the current list")
    after: Optional[StrictStr] = Field(default=None, description="The template after the last template in the current list")

...
class RcsLatLng(BaseModel):
    """
    Latitude and longitude coordinates.
    """ # noqa: E501
    latitude: Union[StrictFloat, StrictInt] = Field(description="The latitude coordinate.")
    longitude: Union[StrictFloat, StrictInt] = Field(description="The longitude coordinate.")

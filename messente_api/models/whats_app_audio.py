...
class WhatsAppAudio(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the audio file.")
    mime_type: Optional[StrictStr] = Field(default=None, description="MIME type of the audio file.")
    link: Optional[StrictStr] = Field(default=None, description="URL link to the audio file.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "mime_type", "link"]

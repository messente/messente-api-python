...
class WhatsappPagination(BaseModel):
    """
    Whatsapp media object.
    """ # noqa: E501
    previous: Optional[StrictStr] = Field(default=None, description="A URL to ge the previous paginated page.")
    next: Optional[StrictStr] = Field(default=None, description="A URL to ge the next paginated page.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "next": obj.get("next"),
            "cursors": WhatsappPagingCursors.from_dict(obj["cursors"]) if obj.get("cursors") is not None else None
        })

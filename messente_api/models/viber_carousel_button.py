...
class ViberCarouselButton(BaseModel):
    ...
    """ # noqa: E501
    label: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Button label text.")
    action_url: StrictStr = Field(description="URL opened when the button is clicked.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["label", "action_url"]

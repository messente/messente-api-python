...
class ViberCarousel(BaseModel):
    """
    Viber carousel object.
    """ # noqa: E501
    items: Annotated[List[ViberCarouselItem], Field(min_length=2, max_length=5)] = Field(description="Carousel items. Must contain between 2 and 5 items.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [ViberCarouselItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })

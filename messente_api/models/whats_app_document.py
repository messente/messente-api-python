...
class WhatsAppDocument(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the document file.")
    caption: Optional[StrictStr] = Field(default=None, description="Caption for the document.")
    mime_type: Optional[StrictStr] = Field(default=None, description="MIME type of the document file.")
    file_name: Optional[StrictStr] = Field(default=None, description="Name of the document file.")
    link: Optional[StrictStr] = Field(default=None, description="URL link to the document file.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "caption", "mime_type", "file_name", "link"]

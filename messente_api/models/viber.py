...
class Viber(BaseModel):
    ...
    image_url: Optional[StrictStr] = Field(default=None, description="URL for the embedded image.")
    ...
    template: Optional[ViberTemplate] = None
    carousel: Optional[ViberCarousel] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["sender", "validity", "ttl", "text", "image_url", "button_url", "button_text", "channel", "video", "template", "carousel"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of carousel
        if self.carousel:
            _dict['carousel'] = self.carousel.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "template": ViberTemplate.from_dict(obj["template"]) if obj.get("template") is not None else None,
            "carousel": ViberCarousel.from_dict(obj["carousel"]) if obj.get("carousel") is not None else None
        })

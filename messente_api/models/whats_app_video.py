...
class WhatsAppVideo(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the video file.")
    caption: Optional[StrictStr] = Field(default=None, description="Caption for the video.")
    mime_type: Optional[StrictStr] = Field(default=None, description="MIME type of the video file.")
    link: Optional[StrictStr] = Field(default=None, description="URL link to the video file.")

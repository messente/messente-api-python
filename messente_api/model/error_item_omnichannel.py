...
def lazy_import():
    ...
    globals()['ErrorCodeOmnichannel'] = ErrorCodeOmnichannel
    globals()['ErrorTitleOmnichannel'] = ErrorTitleOmnichannel


class ErrorItemOmnichannel(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'title': (ErrorTitleOmnichannel,),  # noqa: E501
            'detail': (str,),  # noqa: E501
            'code': (ErrorCodeOmnichannel,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, detail, code, source, *args, **kwargs):  # noqa: E501
        """ErrorItemOmnichannel - a model defined in OpenAPI

...
def lazy_import():
    ...
    globals()['ErrorCodePhonebook'] = ErrorCodePhonebook
    globals()['ErrorTitlePhonebook'] = ErrorTitlePhonebook


class ErrorItemPhonebook(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'title': (ErrorTitlePhonebook,),  # noqa: E501
            'detail': (str,),  # noqa: E501
            'code': (ErrorCodePhonebook,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, detail, code, *args, **kwargs):  # noqa: E501
        """ErrorItemPhonebook - a model defined in OpenAPI

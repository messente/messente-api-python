...
def lazy_import():
    ...
    globals()['ErrorItemNumberLookupError'] = ErrorItemNumberLookupError


class ErrorItemNumberLookup(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'error': (ErrorItemNumberLookupError,),  # noqa: E501
        }
    ...
    def __init__(self, error, *args, **kwargs):  # noqa: E501
        """ErrorItemNumberLookup - a model defined in OpenAPI

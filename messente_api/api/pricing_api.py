...
class PricingApi:
    ...
    def get_pricelist(
        ...
        _param = self._get_pricelist_serialize(
            username=username,
            password=password,
    ...
    @validate_call
    def get_pricelist_with_http_info(
        self,
        username: Annotated[StrictStr, Field(description="The API username")],
        password: Annotated[StrictStr, Field(description="The API password")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_pricelist_without_preload_content(
        self,
        username: Annotated[StrictStr, Field(description="The API username")],
        password: Annotated[StrictStr, Field(description="The API password")],
        _request_timeout: Union[
    ...
    def get_prices(
        ...
        username: Annotated[StrictStr, Field(description="The API username")],
        password: Annotated[StrictStr, Field(description="The API password")],
        country: Annotated[StrictStr, Field(description="The country code, for which to get the prices")],
        format: Annotated[Optional[StrictStr], Field(description="The format of the response. Can be either 'json' or 'xml'. If not specified, defaults to 'json'.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type country: str
        :param format: The format of the response. Can be either 'json' or 'xml'. If not specified, defaults to 'json'.
        :type format: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of

...
class AccountBalanceApi:
    ...
    @validate_call
    def get_account_balance_using_post(
        self,
        username: Annotated[StrictStr, Field(description="The API username")],
        password: Annotated[StrictStr, Field(description="The API password")],
        _request_timeout: Union[
        ...
        _param = self._get_account_balance_using_post_serialize(
            username=username,
            password=password,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_account_balance_using_post_with_http_info(
        self,
        username: Annotated[StrictStr, Field(description="The API username")],
        password: Annotated[StrictStr, Field(description="The API password")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_account_balance_using_post_without_preload_content(
        self,
        username: Annotated[StrictStr, Field(description="The API username")],
        password: Annotated[StrictStr, Field(description="The API password")],
        _request_timeout: Union[
    ...
    def _get_account_balance_using_post_serialize(
        self,
        username,
        password,
        _request_auth,

...
from messente_api.exceptions import ApiTypeError, ApiValueError, ApiException
from messente_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BlacklistApi()
        api_instance.add_to_blacklist  # this is an instance of the class Endpoint
        api_instance.add_to_blacklist()  # this invokes api_instance.add_to_blacklist.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_to_blacklist.callable or self.callable in this class
